...
export const Bus = () => {
  ...
  useEffect(() => {
    fetch("https://localhost:7172/api/Routes/BusRoute")
      .then((res) => res.json())
  ...
  //Handle for bookings acount and amount
    ...
    try{
      const res = await axios.post("https://localhost:7172/api/BookingCountAndAmount/BookingCountAndAmountBus", bookings);
